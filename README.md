...
|------------------------------------------------------------------------|:-----------:|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| `FTBLittleHelper.show(player)`                                         |    void     | Pops the helper up in front of the player; it will fly behind the player after a second or so                                                                                                                                                                                      |
| `FTBLittleHelper.show(player, msgKey)`                                 |    void     | Pops the helper up in front of the player; it will say the message, then fly behind the player after a second or so                                                                                                                                                                |
| `FTBLittleHelper.hide(player)`                                         |    void     | Pops the helper down; it will move to the front of player, and vanish shortly after                                                                                                                                                                                                |
| `FTBLittleHelper.hide(player, msgKey)`                                 |    void     | Pops the helper down; it will move to the front of player, say the message, and vanish shortly after                                                                                                                                                                               |
| `FTBLittleHelper.toggle(player)`                                       |    void     | If the helper is up, hide it; if the helper is down, show it                                                                                                                                                                                                                       |
| `FTBLittleHelper.toggle(player, hiMsgKey, byeMsgKey)`                  |    void     | If the helper is up, hide it; if the helper is down, show it. The greeting or goodbye message is sent to the player, as appropriate.                                                                                                                                               |
